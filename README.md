...
## Vercel
Ele é um host de sites, focado principalmente para front-end, isso faz com que a aplicação fique em deploy contínuo na Vercel. Se eu altero o código, automaticamente sobe para a plataforma também. O Vercel é basicamente uma plataforma de nuvem otimizada, funcionando especialmente para projetos que utilizam a sua _framework in-house_, o Next.js. Funciona num conceito chamado _Edge Network_, ou seja, o site é distribuído por servidores no mundo todo para carregar instantaneamente.
